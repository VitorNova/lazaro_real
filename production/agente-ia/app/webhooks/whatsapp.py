...
from app.tools.functions import FUNCTION_DECLARATIONS, get_function_declarations
...
class WhatsAppWebhookHandler:
    ...
    def _create_function_handlers(
        ...
        from app.services.calendar import GoogleCalendarOAuth, GoogleCalendarOAuthError, create_google_calendar_oauth
        from app.config import settings
...
"""
        ...
        async def identificar_equipamento_handler(
            ...
            **kwargs
            ...
            """
            from app.tools.maintenance import identificar_equipamento
        ...
        async def analisar_foto_equipamento_handler(
            ...
            **kwargs
            ...
            Usado pelo agente Lázaro (Alugar Ar).
            """
            from app.tools.maintenance import analisar_foto_equipamento
        ...
        async def verificar_disponibilidade_manutencao_handler(
            ...
            **kwargs
            ...
            """
            from app.tools.maintenance import verificar_disponibilidade_manutencao
        ...
        async def confirmar_agendamento_manutencao_handler(
            ...
            **kwargs
            ...
            Usado pelo agente Lazaro (Alugar Ar).
            """
            from app.tools.maintenance import confirmar_agendamento_manutencao
    ...
    async def handle_message(
        ...
        try:
            from app.jobs.follow_up import reset_follow_up_on_lead_response
